    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <router-link to="/interview/create" class="nav-link" active-class="active">Create
                        interview</router-link>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto profile-nav">
                <li class="nav-item dropdown" @click="toggleDropdown">
                    <button class="btn btn-secondary dropdown-toggle">Profile</button>
                    <ul v-if="isDropdownOpen" class="dropdown-menu">
                        <li>
                            <router-link class="dropdown-item" to="/profile" v-if="isAuth">Profile</router-link>
